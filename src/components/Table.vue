...
<transition name="fade" appear>
  ...
  <transition name="pop" appear>
    <div class="modal" style="width:30%;"
      ...
      <button type="submit" class="button button--accept" @click="deleteD = false">Aceptar</button>
      <button type="submit" class="button button--cancel" @click="deleteD = false">Cancelar</button>
    </div> 
  </div>
  </transition>
    </div> 
